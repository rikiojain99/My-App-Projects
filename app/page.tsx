      ...
      <div className="min-h-screen bg-gray-100 p-4">
        <div className="max-w-lg  mx-auto space-y-6">
          ...
          <Section title="Bills">
            ...
            {/* //customer-statement */}
            {/* <DashboardLink href="/customer-statement" icon="📂" label="customer-statement" /> */}
          ...
          <Section title="Manufacturing">
            <DashboardLink href="\manufacturing\create" icon="🧾" label="create itmes " />
            <DashboardLink href="\manufacturing\history" icon="📂" label="View Manufacturing itmes " />
          </Section>
